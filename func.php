...
function postCheck($goToErrorPage = false) {
	if(empty($_POST)) {
		if($goToErrorPage) {
			return 1;
		}else {
...
function getCheck($goToErrorPage = false) {
	if(empty($_GET)) {
		if($goToErrorPage) {
			return 1;
		}else {
...
function sessionCheck($goToErrorPage = false) {
	if(!isset($_SESSION)) {
		if($goToErrorPage) {
			return 1;
		}else {
...
function csrfCheck($goToErrorPage = false) {
